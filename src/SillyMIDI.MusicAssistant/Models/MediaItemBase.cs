...
public abstract partial class MediaItemBase
{
    ...
    [NotifyingProperty] [JsonPropertyName("name")] public partial string Name { get; set; }
    [JsonPropertyName("version")] public string? Version { get; set; }
    [JsonPropertyName("sort_name")] public string? SortName { get; set; }
    [JsonPropertyName("uri")] public string? Uri { get; set; }
    [JsonPropertyName("external_ids")] public List<List<string>>? ExternalIds { get; set; }
    [JsonPropertyName("is_playable")] public bool IsPlayable { get; set; }
    [JsonPropertyName("translation_key")] public object? TranslationKey { get; set; }
