...
namespace SillyMIDI.MusicAssistant.RpcExtensions;
...
public static partial class MusicAssistantClientRpcExtensions
{
    ...
    public static async Task<List<PlayerQueue>?> PlayAsync(
    ...
    /// <returns>A list of <see cref="PlayerQueue"/> objects representing the updated queue, or null if the request fails.</returns>
    public static async Task<List<PlayerQueue>?> PlayerGroupVolumeDownAsync(
        this MusicAssistantClientRpc c,
        string playerId)
    {
        return await c.Send<List<PlayerQueue>>(
            ClientHelpers.JustId(Commands.PlayerGroupVolumeDown, playerId, "player_id"));
    }
    ...
    /// <param name="playerId">The ID of the player.</param>
    /// <returns>A list of <see cref="PlayerQueue"/> objects representing the updated queue, or null if the request fails.</returns>
    public static async Task<List<PlayerQueue>?> PlayerGroupVolumeUpAsync(
        this MusicAssistantClientRpc c,
        string playerId)
    {
        return await c.Send<List<PlayerQueue>>(
            ClientHelpers.JustId(Commands.PlayerGroupVolumeUp, playerId, "player_id"));
    }
