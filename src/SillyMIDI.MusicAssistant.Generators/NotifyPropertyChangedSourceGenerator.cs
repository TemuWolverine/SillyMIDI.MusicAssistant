...
public class NotifyPropertyChangedSourceGenerator : IIncrementalGenerator
{
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        context.RegisterSourceOutput(classSymbols, (spc, source) =>
        {
            ...
            var inpcAttrName = "SillyMIDI.MusicAssistant.Generators.Attributes.NotifyPropertyChangedAttribute";
            var inpcPropAttrName = "SillyMIDI.MusicAssistant.Generators.Attributes.NotifyingPropertyAttribute";
            var inpcAlsoForAttrName = "SillyMIDI.MusicAssistant.Generators.Attributes.AlsoNotifyFor";
