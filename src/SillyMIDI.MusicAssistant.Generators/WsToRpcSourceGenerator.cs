...
namespace SillyMIDI.MusicAssistant.Generators;
...
public class WsToRpcSourceGenerator : IIncrementalGenerator
{
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        context.RegisterSourceOutput(compilationAndMethods, (spc, source) =>
        {
            ...
            var toRpcAttrFqn = "SillyMIDI.MusicAssistant.Generators.Attributes.ToRpcAttribute";
            ...
            if (methodsByClass.Count > 0)
            {
                ...
                outSb.AppendLine("using System.Text.Json;");
                outSb.AppendLine("using SillyMIDI.MusicAssistant.Generators.Attributes;");
                outSb.AppendLine("using SillyMIDI.MusicAssistant.Messages;");
                outSb.AppendLine("using SillyMIDI.MusicAssistant.Models;");
                outSb.AppendLine("using SillyMIDI.MusicAssistant.Models.Enums;");
                outSb.AppendLine("using SillyMIDI.MusicAssistant.Responses;");
                outSb.AppendLine();
                outSb.AppendLine("namespace SillyMIDI.MusicAssistant.RpcExtensions");
                outSb.AppendLine("{");
