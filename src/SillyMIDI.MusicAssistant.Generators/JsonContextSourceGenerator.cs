...
public class JsonContextSourceGenerator : IIncrementalGenerator
{
    ...
    private static string GenerateAttributeSource(List<INamedTypeSymbol> types, List<string> includedTypes, string targetNamespace = "SillyMIDI.MusicAssistant")
    {
        ...
        sb.AppendLine("using SillyMIDI.MusicAssistant.Responses;");
        sb.AppendLine();
